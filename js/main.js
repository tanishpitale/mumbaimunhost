...
jQuery(document).on('ready', function() {
	...
	var hash = window.location.hash;
	    ...
	    hash && $('ul.tg-eventschedulenav li a[href="' + hash + '"]').tab('show');
			$('body').scrollTop();
	...
	_tg_upcomingeventcounter.countdown('2019/10/06', function(event) {
	...
	_tg_upcomingeventcountervtwo.countdown('2019/10/07', function(event) {
		var $this = jQuery(this).html(event.strftime(''
	...
	_tg_locationmap.gmap3({
		marker: {
			address: "Mukesh Patel School of Technology Management & Engineering",
			options: {
				title: "Mumbai MUN 2018"
			}
		},
		map: {
			options: {
